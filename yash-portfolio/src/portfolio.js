...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Software Developer 🚀 experienced in building Web applications with Angular, Java, Reactjs, Nodejs."
  ),
  resumeLink:
    "https://drive.google.com/file/d/19XWiVSGbhvHReMi0grrKbkuSmpFm8i3J/view?usp=sharing", // Set to empty to hide the button
...
const socialMediaLinks = {
  ...
  gitlab: "https://git.cs.dal.ca/yna",
...
const skillsSection = {
  ...
  skills: [
    ...
    emoji("⚡ Creating application backend in Java, Node, Express & Flask"),
    emoji(
...
const educationInfo = {
  ...
  schools: [
    {
      schoolName: "Dalhousie University, Halifax, Canada",
      logo: require("./assets/images/dalhousieLogo.jpeg"),
    ...
    },
    {
      ...
      logo: require("./assets/images/karunyaLogo.png"),
  ...
  experience: [
    {
      ...
      companylogo: require("./assets/images/CAN-Revenue-Agency.jpeg"),
...
const blogSection = {
  ...
  blogs: [
    ...
    {
      url: "https://medium.com/@yashpasta/why-react-is-the-best-5a97563f423e",
  ...
  talks: [
    {
      ...
      slides_url: "https://bit.ly/yashpasta-slides",
...
const podcastSection = {
  ...
  podcast: [
    "https://anchor.fm/codevcast/embed/episodes/DevStory---yash-Pasta-from-Karachi--Pakistan-e9givv/a-a15itvo"
  ],
  display: true // Set false to hide this section, defaults to true
};
